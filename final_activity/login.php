...
if(!empty($_SESSION["role"]))
{
  ...
  {
    header("Location: https://".$_SERVER['SERVER_NAME']."/kahitsinoprogrammer/finalactivity/admin/homepage.php");
  }
  else 
  {
    header("Location: https://".$_SERVER['SERVER_NAME']."/kahitsinoprogrammer/finalactivity/employee/homepage.php");
  }
}
        ...
        const theformtosubmit = document.getElementById('theform');
            theformtosubmit.addEventListener('submit', function(event) {
                ...
                else 
                {
                    ...
                    xmlhttp.open("POST", "loginajax.php?PH=" + Date.now(), true);
                    xmlhttp.send(FDa);
                }
